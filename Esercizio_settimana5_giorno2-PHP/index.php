<?php
  ...
  if(!isset($_SESSION['userLogin']) && isset($_COOKIE["useremail"]) && isset($_COOKIE["userpassword"])) {
    header('Location: http://localhost/Back-end/Esercizio_settimana5_giorno2-PHP/controller.php?email='.$_COOKIE["useremail"].'&password='.$_COOKIE["userpassword"]);
  } else if(!isset($_SESSION['userLogin'])) {
    header('Location: http://localhost/Back-end/Esercizio_settimana5_giorno2-PHP/login.php');
  } 

  if(!isset($_SESSION['content'])){
    header('Location: http://localhost/Back-end/Esercizio_settimana5_giorno2-PHP/language.php?lang=it');
  }
